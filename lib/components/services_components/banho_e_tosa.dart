...
class BanhoETosa extends StatefulWidget {
  const BanhoETosa({super.key});

  @override
  State<BanhoETosa> createState() => _BanhoETosaState();
}

class _BanhoETosaState extends State<BanhoETosa> {
  ...
  List<Widget> _buildHorarioContainers(Size screenSize) {
    Provider.of<Services>(context, listen: false).getBanhoETosaSchedules();
    ...
    List<String> horariosDisponiveis =
        servicesProvider.horariosBanhoETosaDisponiveis
  ...
  _onSave(
    ...
    if (_selectedHorario != null && _dateController.text.isNotEmpty) {
      ...
      BanhoETosaSchedule newSchedule = BanhoETosaSchedule(
        day: selectedDate,
        schedule: _selectedHorario!,
        service: _servicoSelecionado,
      ...
      servicesProvider.updateBanhoETosaSchedule(newSchedule);
  ...
  Widget build(BuildContext context) {
    ...
    List<String> availlableServicesList =
        servicesProvider.servicesList.keys.toList();
    availlableServicesList.removeLast();
            ...
            title: Padding(
              ...
              child: Row(
                ...
                children: [
                  const SizedBox(),
                  Text(
                    "Agendamento de banho e / ou tosa",
                    style: TextStyle(
                      fontFamily: 'NunitoSansBold',
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          for (String servico in availlableServicesList)
                            SizedBox(
                              ...
                              child: RadioListTile<int?>(
                                ...
                                value: servicesProvider.servicesList[servico],
